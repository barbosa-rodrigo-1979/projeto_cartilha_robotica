// ==================================================
// index.js – UNIFICADO PARA O PROJETO
...
(function () {
  ...
  // ==============================================
  // MÓDULO CABEÇALHO (modelo_cabecalho.js)
  // ==============================================
  ...
  const MenuModule = {
    init() {
      ...
      var mapaPaginas = {
        ...
        'a1index.html': 'a[href="a1index.html"]',
        'a2index.html': 'a[href="a2index.html"]',
        'a3index.html': 'a[href="a3index.html"]',
        'a4index.html': 'a[href="a4index.html"]',
        'a5index.html': 'a[href="a5index.html"]'
      };
    ...
    configurarEventos() {
      ...
      document.addEventListener('robo:vitoria', () => {
        if (this.relatorioElement) {
          ...
          setTimeout(() => {
            if (this.relatorioElement) this.relatorioElement.style.color = '';
          }, 500);
        }
      });
    },
  ...
  function initAll() {
    ...
    // Inicializa certificado (se estiver na página)
    ...
    window.dispatchEvent(new Event('controlador:pronto'));
    console.log('🚀 [SISTEMA] Todos os módulos inicializados!');
  }
