// ==================================================
// a4bim2_hardware.js
// Scripts unificados para 4º Ano | 2º Bimestre | Hardware
// Baseado nos modelos: modelo_menu_bim.js, modelo_cabecalho.js,
// modelo_rodape.js, modelo_planos_aula.js, modelo_apresentacao_bimestre.js,
...
(function () {
  ...
  // ==================================================
  // 1. MENU BIMESTRAL (modelo_menu_bim.js)
  // ==================================================
  const MenuModule = {
    inicializado: false,
    ...
    highlightCurrentPage() {
      const currentPath =
        window.location.pathname.split("/").pop() || "a4bim2_hardware.html";
    ...
    consoleWelcome() {
      console.log(
        "%c🤖 ROBOZADA 3000 - 4º ANO | 2º BIMESTRE | HARDWARE ATIVO",
        "color: #ffb347; font-size: 14px; font-family: monospace;",
      );
      console.log(
        "%c🔁 Loop dentro de loop | SE, SENÃO SE, SENÃO | Aninhamento é poder!",
        "color: #9bbc7b;",
      );
    },
  ...
  // ==================================================
  // 4. PLANOS DE AULA (modelo_planos_aula.js)
  // ==================================================
  ...
  // ==================================================
  // 5. APRESENTAÇÃO (modelo_apresentacao_bimestre.js)
  // ==================================================
  const ApresentacaoModule = {
    ...
    efeitoBrilhoTabela() {
      const tabelas = document.querySelectorAll(".table-robotica");
  ...
  // ==================================================
  // 6. CERTIFICADO (modelo_certificado.js)
  // ==================================================
  const CertificadoModule = {
    inicializado: false,
    alunos: [],
    STORAGE_KEY: "robozada_certificados_ano4_bim2",
      ...
      <body>
        <div class="preview-container">
          ...
          <div class="certificado">
            <h3>🏆 CERTIFICADO — 4º ANO | 2º BIMESTRE</h3>
            <p>Certificamos que</p>
            <strong class="nome">${this.escapeHtml(nome)}</strong>
            <p>concluiu com êxito o <strong>2º BIMESTRE - ROBÓTICA EDUCACIONAL</strong><br>
            🔁 LOOP DENTRO DE LOOP | SE, SENÃO SE, SENÃO | 📦 CONTADORES E ACUMULADORES | 🐛 DEPURAÇÃO AVANÇADA</p>
            <hr>
            <p>RobôMestres do Paraná • ${data}</p>
            <p style="font-size:11px; font-style:italic;">"Aninhar código é só mais uma brincadeira!"</p>
    ...
    imprimirTodosCertificados() {
      ...
      this.alunos.forEach((aluno) => {
        cardsHTML += `
          <div class="certificado-impressao" style="border:3px solid #ffb347; border-radius:48px 24px 48px 24px; padding:20px; text-align:center; background:#fffef7; break-inside:avoid; page-break-inside:avoid;">
            <h3 style="color:#ffb347; font-family:'Press Start 2P',cursive; font-size:0.7rem;">🏆 CERTIFICADO — 4º ANO | 2º BIMESTRE</h3>
            ...
            <p style="color:#4a6e2c;">concluiu o <strong>2º BIMESTRE - ROBÓTICA EDUCACIONAL</strong><br>
            🔁 LOOP DENTRO DE LOOP | SE, SENÃO SE, SENÃO | 📦 CONTADORES E ACUMULADORES</p>
            <hr style="margin:12px 0; border:1px solid #ffb347;">
            <p style="font-size:0.65rem; color:#6b8c5c;">RobôMestres do Paraná • ${dataAtual}</p>
            <p style="font-size:0.6rem; color:#b4621a; font-style:italic;">"Aninhar código é só mais uma brincadeira!"</p>
      ...
      <head>
        <meta charset="UTF-8">
        <title>Certificados RobôMestres - 4º Ano | 2º Bimestre</title>
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  function initAllModules() {
    ...
    console.log(
      "%c🤖 TODOS OS MÓDULOS INICIALIZADOS! 4º ANO | 2º BIMESTRE | HARDWARE",
      "color: #ffb347; font-size: 16px; font-weight: bold; font-family: monospace;",
    );
  }
